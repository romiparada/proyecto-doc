...
El estudio en conjunto de estas dimensiones nos permite determinar un veredicto para las historias de usuario generadas, considerando tanto utilidad práctica en el desarrollo de software, coherencia interna de cada historia, su fidelidad con las demás historias del conjunto y su correspondencia con el dominio del documento de requisitos.
