...
La búsqueda se realizó en cuatro ámbitos principales: motores de búsqueda generales, repositorios de código abierto, tiendas o mercados dentro de herramientas de gestión de proyectos y plataformas de inteligencia artificial. Para cada herramienta encontrada, se registraron aspectos como el tipo de entrada y salida soportado, el nivel de integración con otras herramientas y el modelo de IA utilizado.
