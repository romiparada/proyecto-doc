...
RequirementLinter, es una herramienta para el análisis de historias de usuario o requerimientos \cite{requirementlinter}. Se centra en identificar la calidad de las historias, no en su generación. Esta herramienta es filtrada ya que no cumple.
...
Reqnroll \cite{reqnroll} fue filtrada ya que no menciona la generación de historias de usuario, ya que consiste en una herramienta de pruebas.
