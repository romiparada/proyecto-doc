...
StoryCraft fue filtrada ya que requiere procesar requerimiento por requerimiento, no a partir del documento completo.
...
StoryBot fue filtrada ya que no fue posible generar las historias de usuario correctamente durante la prueba.
...
StoriesOnBoard & \textbf{Filtrada}, no genera a partir de documentos & 23/11/2025 \\
