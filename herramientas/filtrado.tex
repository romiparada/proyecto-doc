...
Specifai fue incluida ya que genera en base a un título y una mínima descripción opcional, luego permite agregar requisitos en formato texto. Se puede iterar sobre lo generado, según la vista previa de la aplicacion contiene un chat, pero no fue posible encontrarlo y utilizarlo en la prueba.
...
Por lo tanto tenemos 11 herramientas para evaluar sus historias de usuario. Se decidió hacer un ranking dados los requisitos, para seleccionar las herramientas más completas.
