...
Por ejemplo, en la figura \ref{fig:ejemplo_prompt} se ejemplifica un prompt Traducir al inglés, que indica la traducción al inglés de la frase Hola Mundo.
